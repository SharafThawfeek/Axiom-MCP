...
from axiom_debug.agent.loop import run_agent
from axiom_debug.config import settings
from axiom_debug.core.exceptions import AnalysisFailed
...
from axiom_debug.schemas.analysis import Analysis, AnalysisResponse
        ...
        if failure:
            ...
            if cached is not None:
                logger.info(
                    ...
                    datetime.now(UTC) - cached.created_at,
                )
                if run is not None:
