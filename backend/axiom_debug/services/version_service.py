...
# Fetched by name rather than imported from axiom_debug.core.logger, which
# would execute axiom_debug/core/__init__.py and pull in FastAPI through
# core.exceptions. This module is on the MCP server's lean import path,
# where FastAPI isn't installed. Same logger object either way — core.logger
# configures the handlers on this exact name when the HTTP app is running.
